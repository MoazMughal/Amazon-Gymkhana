...
const EditProfile = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    // Google OAuth sellers have no password — skip password modal
  ...
  // Direct update for Google OAuth sellers (no password needed)
  const handleDirectUpdate = async () => {
    setLoading(true)
    try {
      const token = sessionStorage.getItem('sellerToken') || localStorage.getItem('sellerToken')
            ...
            <div className="card-body">
              <form onSubmit={handleSubmit}>
                ...
                <div className="d-flex gap-2 flex-wrap">
                  ...
                  {seller?.authProvider !== 'google' && seller?.authProvider !== 'facebook' && (
                    <button 
                      type="button" 
                  ...
                  {(seller?.authProvider === 'google' || seller?.authProvider === 'facebook') && (
                    <span style={{
                      ...
                      padding: '6px 12px', background: '#fff3e0', borderRadius: '6px',
                      fontSize: '0.82rem', color: '#e65100', border: '1px solid #ffcc80'
                    }}>
                      ...
                      Password managed by {seller?.authProvider === 'facebook' ? 'Facebook' : 'Google'}
                    </span>
                  )}
                  <button 
                    type="button" 
